                                        ...
                                        <div key={level}>
                                            ...
                                            <div className="grid gap-2">
                                                {knownSpellsByLevel[level].map(spell => {
                                                    const spellDetails = SPELL_DETAILS[spell];
                                                    return (
                                                        ...
                                                        <div>
                                                            ...
                                                            {spellDetails && (
                                                                <div className="text-xs text-stone-500 mt-1 flex items-center gap-2">
                                                                    <span>{spellDetails.school}</span>
                                                                    <span className="w-1 h-1 bg-stone-600 rounded-full"></span>
                                                                    <span>{spellDetails.castingTime}</span>
                                                                </div>
                                                            )}
                                                        </div>
